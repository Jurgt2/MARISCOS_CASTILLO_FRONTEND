          ...
          <div key={categoria}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-8">
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-xl rounded-2xl hover:shadow-2xl transition-all border border-gray-200 p-4 flex flex-col items-center justify-between min-h-[220px] min-w-[180px] max-w-[180px] max-h-[220px] aspect-square">
