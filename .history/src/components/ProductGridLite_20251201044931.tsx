      ...
      <div className="space-y-10">
        {categorias.map(categoria => (
          <div key={categoria}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-20 gap-y-20 justify-items-center">
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-5 flex flex-col items-center justify-between min-h-[240px] min-w-[200px] max-w-[200px] max-h-[240px] aspect-square">
                  <div className="font-extrabold text-base text-primary mb-2 text-center uppercase leading-tight break-words whitespace-normal">
                    {product.nombre}
                  </div>
                  <div className="text-sm text-gray-500 mb-2 text-center break-words whitespace-normal">
                    {product.descripcion}
                  </div>
