          ...
          <div key={categoria}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-xl rounded-2xl hover:shadow-2xl transition-all border border-gray-200 p-6 flex flex-col items-center justify-between min-h-[220px]">
                  <div className="font-extrabold text-lg text-primary mb-2 text-center uppercase leading-tight">{product.nombre}</div>
                  <div className="text-sm text-gray-500 mb-2 text-center">{product.descripcion}</div>
