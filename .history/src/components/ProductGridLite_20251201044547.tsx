      ...
      <div className="space-y-10">
        {categorias.map(categoria => (
          <div key={categoria}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-x-10 gap-y-10">
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-4 flex flex-col items-center justify-between min-h-[200px] min-w-[180px] max-w-[180px] max-h-[200px] aspect-square">
