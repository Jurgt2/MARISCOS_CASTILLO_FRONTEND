        ...
        {categorias.map(categoria => (
          <div key={categoria}>
            ...
            <div className="w-full overflow-x-auto pb-4 ml-8">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-8 justify-items-center items-center mx-auto">
                {lista.filter(p => p.categoria === categoria).map(product => (
                  <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-2 flex flex-col items-center justify-between min-h-[90px] min-w-[160px] max-w-[160px] max-h-[90px] mx-1 my-1">
