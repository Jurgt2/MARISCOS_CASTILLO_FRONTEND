            ...
            <div className="w-full overflow-x-auto pb-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-16 gap-y-16 justify-items-center min-w-max">
                {lista.filter(p => p.categoria === categoria).map(product => (
                  <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-2 flex flex-col items-center justify-between min-h-[140px] min-w-[110px] max-w-[110px] max-h-[140px] aspect-square mx-2 my-1">
