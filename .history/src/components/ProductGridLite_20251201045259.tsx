      ...
      <div className="space-y-10">
        {categorias.map(categoria => (
          <div key={categoria}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-16 gap-y-16 justify-items-center">
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-6 flex flex-col items-center justify-between min-h-[260px] min-w-[220px] max-w-[220px] max-h-[260px] aspect-square">
