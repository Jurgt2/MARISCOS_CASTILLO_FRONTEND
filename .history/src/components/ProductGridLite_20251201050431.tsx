            ...
            <div className="w-full overflow-x-auto pb-4 ml-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-16 gap-y-16 justify-items-center min-w-max">
                {lista.filter(p => p.categoria === categoria).map(product => (
                  <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-6 flex flex-col items-center justify-between min-h-[120px] min-w-[260px] max-w-[260px] max-h-[180px] mx-2 my-2">
                    <div className="font-extrabold text-xl text-primary mb-2 text-center uppercase leading-tight break-words whitespace-normal">
                      {product.nombre}
                    </div>
