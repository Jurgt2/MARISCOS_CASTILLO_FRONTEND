        ...
        {categorias.map(categoria => (
          <div key={categoria}>
            ...
            <div className="w-full overflow-x-auto pb-4 ml-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-2 gap-y-2 justify-items-center items-center min-w-max">
