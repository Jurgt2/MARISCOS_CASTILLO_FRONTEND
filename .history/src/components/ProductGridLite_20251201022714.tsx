...
const ProductGridLite = ({ productos }: ProductGridLiteProps) => {
  const ProductGridLite = ({ productos, onProductClick }: ProductGridLiteProps) => {
  const { currentTable, addItem } = useOrderStore();
  const { onProductClick } = arguments[0];
...
export default ProductGridLite;
