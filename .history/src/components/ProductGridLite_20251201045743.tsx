          ...
          <div key={categoria}>
            ...
            <div className="w-full overflow-x-auto pb-4">
              ...
              {lista.filter(p => p.categoria === categoria).map(product => (
                <div key={product.id} className="card bg-white shadow-2xl rounded-2xl border-2 border-gray-300 p-6 flex flex-col items-center justify-between min-h-[260px] min-w-[220px] max-w-[220px] max-h-[260px] aspect-square mx-4 my-2">
