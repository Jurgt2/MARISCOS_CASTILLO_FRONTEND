...
// Agrega aquí solo los imports que realmente uses en el componente
function Gerente() {
  // Estado para mostrar/ocultar historial de órdenes
  const [showOrderHistory, setShowOrderHistory] = useState(false);
  // Obtener todas las órdenes del store para el historial
        ...
        {activeTab === 'ordenes' && (
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
            <div className="w-full mb-8">
              ...
              >
                {showOrderHistory ? 'Ocultar Historial de Órdenes' : 'Ver Historial de Órdenes'}
              </button>
              {showOrderHistory && (
                <div className="bg-white rounded shadow p-4 mb-6">
                  <h2 className="text-xl font-bold mb-2">Historial de Órdenes</h2>
