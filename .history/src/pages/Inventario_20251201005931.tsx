...
function Inventario() {
  ...
  const [ingredientes] = useState([
    { id: 'FQR59', nombre: 'Camarón U15', categoria: 'PROTEINA', cantidad: 25, unidad: 'kg', cantidadMinima: 10, costoUnitario: 120, proveedor: 'Mariscos del Golfo', ultimaActualizacion: new Date().toISOString() },
    { id: 'NID92', nombre: 'Camarón U21', categoria: 'PROTEINA', cantidad: 30, unidad: 'kg', cantidadMinima: 10, costoUnitario: 110, proveedor: 'Mariscos del Golfo', ultimaActualizacion: new Date().toISOString() },
    { id: 'AEJ80', nombre: 'Pulpo Español', categoria: 'PROTEINA', cantidad: 15, unidad: 'kg', cantidadMinima: 5, costoUnitario: 200, proveedor: 'Mariscos del Golfo', ultimaActualizacion: new Date().toISOString() },
    { id: 'MIE57', nombre: 'Filete de Robalo', categoria: 'PROTEINA', cantidad: 20, unidad: 'kg', cantidadMinima: 8, costoUnitario: 180, proveedor: 'Pescados Frescos', ultimaActualizacion: new Date().toISOString() },
    { id: 'BNJ39', nombre: 'Mojarra', categoria: 'PROTEINA', cantidad: 25, unidad: 'kg', cantidadMinima: 10, costoUnitario: 90, proveedor: 'Pescados Frescos', ultimaActualizacion: new Date().toISOString() },
    { id: 'URV39', nombre: 'Huachinango', categoria: 'PROTEINA', cantidad: 3, unidad: 'kg', cantidadMinima: 2, costoUnitario: 220, proveedor: 'Pescados Frescos', ultimaActualizacion: new Date().toISOString() },
    { id: 'LYZ27', nombre: 'Jaiba', categoria: 'PROTEINA', cantidad: 10, unidad: 'kg', cantidadMinima: 3, costoUnitario: 150, proveedor: 'Mariscos del Golfo', ultimaActualizacion: new Date().toISOString() },
    { id: 'IYQ22', nombre: 'Ostiones', categoria: 'PROTEINA', cantidad: 8, unidad: 'kg', cantidadMinima: 2, costoUnitario: 130, proveedor: 'Mariscos del Golfo', ultimaActualizacion: new Date().toISOString() },
    { id: 'BEB01', nombre: 'Coca-Cola', categoria: 'BEBIDA', cantidad: 40, unidad: 'botellas', cantidadMinima: 10, costoUnitario: 18, proveedor: 'Coca-Cola FEMSA', ultimaActualizacion: new Date().toISOString() },
    { id: 'BEB02', nombre: 'Agua Mineral', categoria: 'BEBIDA', cantidad: 30, unidad: 'botellas', cantidadMinima: 10, costoUnitario: 15, proveedor: 'Peñafiel', ultimaActualizacion: new Date().toISOString() },
    { id: 'BEB03', nombre: 'Cerveza Corona', categoria: 'BEBIDA', cantidad: 50, unidad: 'botellas', cantidadMinima: 15, costoUnitario: 22, proveedor: 'Grupo Modelo', ultimaActualizacion: new Date().toISOString() },
    { id: 'BEB04', nombre: 'Cerveza Victoria', categoria: 'BEBIDA', cantidad: 35, unidad: 'botellas', cantidadMinima: 10, costoUnitario: 22, proveedor: 'Grupo Modelo', ultimaActualizacion: new Date().toISOString() },
    { id: 'BEB05', nombre: 'Agua Natural', categoria: 'BEBIDA', cantidad: 60, unidad: 'botellas', cantidadMinima: 20, costoUnitario: 12, proveedor: 'Bonafont', ultimaActualizacion: new Date().toISOString() }
  ]);
