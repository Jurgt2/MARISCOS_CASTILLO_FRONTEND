                        ...
                        <table className="w-full mb-6 rounded overflow-hidden">
                          <thead>
                            <tr className="bg-yellow-100 text-yellow-800">
                              <th className="text-left py-1 px-1 font-semibold text-sm">Platillo</th>
                              <th className="text-center py-1 px-1 font-semibold text-sm">Cantidad</th>
                              <th className="text-center py-1 px-1 font-semibold text-sm">Precio unitario</th>
                              <th className="text-center py-1 px-1 font-semibold text-sm">Notas</th>
                              <th className="text-right py-1 px-1 font-semibold text-sm">Subtotal</th>
                            </tr>
                          </thead>
                          <tbody>
