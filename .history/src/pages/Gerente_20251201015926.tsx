          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="card-castillo">
                <div className="card-body">
                  ...
                  {/* Aquí puedes agregar filtros y búsqueda si lo deseas */}
                  <ProductGridLite />
                </div>
              </div>
              ...
              <div className="card-castillo">
                <div className="card-body">
                  ...
                  {/* Aquí iría el componente de selección de mesa y número de comensales */}
                  {/* Ejemplo: <TableMap ... /> y campo para comensales */}
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                {/* Aquí va el resumen de la orden, puedes usar OrderSummary */}
                {/* <OrderSummary ... /> */}
              </div>
              ...
              <div className="mt-8">
                <div className="card-castillo">
                  <div className="card-body">
                    ...
                    {/* Aquí va el historial de órdenes recientes y su estado */}
                  </div>
                </div>
              </div>
            </div>
