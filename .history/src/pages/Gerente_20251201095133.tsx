            ...
            <div className="card-castillo">
              <div className="card-body">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  ...
                  >
                    <span className="text-2xl">➕</span> Agregar Insumo
                  </button>
                </div>
              </div>
            </div>
            ...
            {showAddInsumoModal && (
              <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                  <h2 className="text-lg font-bold mb-4">Agregar nuevo insumo</h2>
                  <form onSubmit={handleAddInsumo} className="flex flex-col gap-3">
                    <input type="text" name="nombre" placeholder="Nombre del insumo" className="border rounded px-3 py-2" required />
                    <input type="text" name="categoria" placeholder="Categoría" className="border rounded px-3 py-2" required />
                    <input type="number" name="cantidad" placeholder="Cantidad" className="border rounded px-3 py-2" required min="0" />
                    <input type="text" name="proveedor" placeholder="Proveedor" className="border rounded px-3 py-2" />
                    <input type="text" name="unidad" placeholder="Unidad (kg, piezas, etc)" className="border rounded px-3 py-2" />
                    <div className="flex gap-2 mt-2">
                      <button type="submit" className="bg-green-600 text-white px-4 py-2 rounded">Guardar</button>
                      <button type="button" className="bg-gray-300 px-4 py-2 rounded" onClick={() => setShowAddInsumoModal(false)}>Cancelar</button>
                    </div>
                  </form>
                </div>
              </div>
