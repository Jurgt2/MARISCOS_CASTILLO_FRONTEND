                    ...
                    {ordersByTable[selectedTables[0]?.id]?.ticket && (
                      <div className="mt-8 card-castillo p-6 bg-white shadow-xl">
                        ...
                        <div className="text-right text-xs text-gray-500">
                          Fecha: {ordersByTable[selectedTables[0].id].ticket.fecha}
                        </div>
                      </div>
                    )}
                  </div>
                ...
                >
                  ...
                  {showMenu && (
                    <ProductGridLite
                      ...
                      onAddProduct={(product, cantidad, notas, modifiers) => {
                        if (selectedTables.length === 1) {
                          addItemToTable(selectedTables[0].id, product, cantidad, notas, modifiers);
                        } else {
