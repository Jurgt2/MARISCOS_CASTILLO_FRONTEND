              ...
              <div className="card-castillo w-full mb-6">
                <div className="card-body flex flex-col items-center">
                  ...
                  {selectedTables.length > 0 && (
                    <div className="mt-6 px-6 py-3 rounded-xl bg-white text-primary font-bold text-base shadow text-center border-4 border-primary">
                ...
                <div className="card-castillo">
                  <div className="card-body">
                    ...
                    {ordersByTable[selectedTables[0]]?.ticket && (
                      <div className="mt-8 card-castillo p-8 bg-white shadow-2xl rounded-2xl border-2 border-yellow-400 max-w-lg mx-auto">
                        ...
                        <table className="w-full mb-6 rounded overflow-hidden">
                          <thead>
                            <tr className="bg-yellow-100 text-yellow-800">
                              <th className="text-left py-3 px-2 font-semibold">Platillo</th>
                              <th className="text-center py-3 px-2 font-semibold">Cantidad</th>
                              <th className="text-center py-3 px-2 font-semibold">Precio unitario</th>
                              <th className="text-center py-3 px-2 font-semibold">Notas</th>
