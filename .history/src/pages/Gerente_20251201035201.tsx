      ...
      <div className="container mx-auto px-6 py-6">
        ...
        {activeTab === 'ordenes' && (
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
                    ...
                    {showPaymentModal && (
                      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
                        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
                          <h2 className="text-xl font-bold mb-4 text-primary">Cobro de mesa</h2>
                          <div className="mb-4">
                            <label className="block font-semibold mb-1">Selecciona la mesa a pagar:</label>
                            <select
                              className="select select-bordered w-full"
                              value={selectedMesaPago}
                              onChange={e => setSelectedMesaPago(e.target.value)}
                            >
                          ...
                          <div className="mb-4">
                            <label className="block font-semibold mb-1">Monto a cobrar:</label>
                            <input
                              type="number"
                          ...
                          <div className="mb-4">
                            <label className="block font-semibold mb-1">Resumen de cuenta:</label>
                            <div className="bg-gray-100 rounded p-3">
                              {/* Aquí puedes mostrar el resumen de la cuenta, productos, total, etc. */}
                              <span className="text-gray-700">Total a pagar: $0.00</span>
                            </div>
                          </div>
            ...
            <div className="w-full lg:w-1/3 flex flex-col items-center">
              <div className="w-full">
                <h2 className="text-2xl font-bold mb-4 text-primary text-center">Selecciona una o varias mesas</h2>
                <TableMap tables={tables} selectedTables={selectedTables} setSelectedTables={setSelectedTables} onTableUpdate={() => {}} />
                    <button
