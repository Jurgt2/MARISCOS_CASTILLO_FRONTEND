                          ...
                          <div className="mt-8 card-castillo p-4 bg-white shadow-lg">
                            ...
                            <ul className="divide-y divide-gray-200">
                              <li className="flex items-center justify-between py-2">
                                <div>
                                  <span className="font-bold text-gray-800">{selectedProduct.nombre}</span>
                                  {/* Aquí puedes mostrar cantidad, variantes, notas, etc. */}
                                </div>
                                <div className="flex items-center gap-2">
                                  {/* Botón para eliminar el platillo del carrito */}
                                  <button className="btn btn-xs btn-circle btn-error" onClick={() => setSelectedProduct(null)}>🗑️</button>
                                </div>
                              </li>
                            </ul>
                            {/* Aquí puedes agregar el total, botón de confirmar, etc. */}
                            <div className="mt-4 text-right font-bold text-lg text-success">
                              Total: ${selectedProduct.precio.toFixed(2)}
                            </div>
