...
export default function Inventario() {
  ...
  const [productos, setProductos] = useState([
    { id: 101, nombre: 'Camarón U15', categoria: 'PROTEINA', cantidad: 25, caducidad: '2025-12-01', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
    { id: 102, nombre: 'Camarón U21', categoria: 'PROTEINA', cantidad: 30, caducidad: '2025-12-05', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
  ]);
