                    ...
                    <ProductGridLite
                      ...
                      onAddProduct={(
                        ...
                        if (selectedTables.length === 1) {
                          // Obtener el nombre correcto del producto (puede ser 'name' o 'nombre')
                          const nombreProducto = product.name || product.nombre;
                          
                          // Verificar si hay stock suficiente
                          const stockActual = platillosInventario[nombreProducto] || 0;
                          
                          if (stockActual === 0) {
                            toast.error(`⚠️ Sin stock de "${nombreProducto}". Agrega stock primero en la pestaña Inventario.`);
                            return;
                          }
                          ...
                          setPlatillosInventario(prev => {
                            const nuevoStock = {
                              ...prev,
                              [nombreProducto]: (prev[nombreProducto] || 0) - cantidad
                            };
