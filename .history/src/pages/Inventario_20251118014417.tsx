...
export default function Inventario() {
  ...
  const [productos, setProductos] = useState([
    { id: 'ABC12', nombre: 'Camarón U15', categoria: 'PROTEINA', cantidad: 25, caducidad: '2025-12-01', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
    { id: 'ABC22', nombre: 'Camarón U21', categoria: 'PROTEINA', cantidad: 30, caducidad: '2025-12-05', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
  ]);
  ...
  const handlePesaje = () => {
    ...
    const productoId = productoIdInput ? parseInt(productoIdInput) : null;
    const producto = productos.find((p) => p.id === productoId);
