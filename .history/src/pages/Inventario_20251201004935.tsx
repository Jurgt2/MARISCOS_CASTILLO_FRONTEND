    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="bg-blue-900 text-white py-4 px-8 flex justify-between items-center">
        <div>
          ...
          <span className="text-sm">Mariscos Castillo</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="font-semibold">Gerente Castillo</span>
          <button className="bg-red-500 text-white px-4 py-2 rounded">Salir</button>
        </div>
      </div>

      {/* Navegación secundaria */}
      <div className="bg-blue-200 flex gap-2 px-8 py-2">
        <button className="bg-blue-300 px-4 py-2 rounded">Dashboard</button>
        <button className="bg-blue-300 px-4 py-2 rounded">Toma de Órdenes</button>
        <button className="bg-blue-300 px-4 py-2 rounded">Reportes</button>
        <button className="bg-blue-600 text-white px-4 py-2 rounded">Inventario</button>
        <button className="bg-blue-300 px-4 py-2 rounded">Configuración</button>
      </div>
