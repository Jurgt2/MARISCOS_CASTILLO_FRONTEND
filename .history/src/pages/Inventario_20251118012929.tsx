...
export default function Inventario() {
  ...
  const handleRecepcion = () => {
    const producto = {
      ...
      nombre: 'Camarón U15',
      categoria: 'PROTEINA',
      peso: Math.random() * 20 + 5, // Simular peso
      temperatura: Math.random() * 10 + 2, // Simular temperatura
      fechaCaducidad: prompt('Ingrese la fecha de caducidad (YYYY-MM-DD):'),
      proveedor: 'Mariscos del Golfo',
    };
    console.log('Recepción de mercancía:', producto);
    alert('Recepción completada para ' + producto.nombre);
  };
