                  ...
                  <div className="card-body">
                    ...
                    {ordersByTable[selectedTables[0]]?.ticket && (
                      <div className="mt-8 card-castillo p-6 bg-white shadow-xl">
                        <h3 className="text-xl font-bold text-warning mb-4">Ticket de la mesa {tables.find(t => t.id === selectedTables[0])?.number}</h3>
                        ...
                        <div className="text-right text-2xl font-bold text-success mb-2">
                          Total: ${ordersByTable[selectedTables[0]].total.toFixed(2)}
                        </div>
