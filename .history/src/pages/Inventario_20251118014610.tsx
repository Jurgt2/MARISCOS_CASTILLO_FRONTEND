...
export default function Inventario() {
  ...
  const [productos, setProductos] = useState([
    { id: generateUniqueId(), nombre: 'Camarón U15', categoria: 'PROTEINA', cantidad: 25, caducidad: '2025-12-01', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
    { id: generateUniqueId(), nombre: 'Camarón U21', categoria: 'PROTEINA', cantidad: 30, caducidad: '2025-12-05', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
    { id: generateUniqueId(), nombre: 'Pulpo Español', categoria: 'PROTEINA', cantidad: 15, caducidad: '2025-12-10', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
    { id: generateUniqueId(), nombre: 'Filete de Robalo', categoria: 'PROTEINA', cantidad: 20, caducidad: '2025-12-15', proveedor: 'Pescados Frescos', estado: 'ÓPTIMO' },
    { id: generateUniqueId(), nombre: 'Mojarra', categoria: 'PROTEINA', cantidad: 25, caducidad: '2025-12-20', proveedor: 'Pescados Frescos', estado: 'ÓPTIMO' },
    { id: generateUniqueId(), nombre: 'Huachinango', categoria: 'PROTEINA', cantidad: 3, caducidad: '2025-12-25', proveedor: 'Pescados Frescos', estado: 'BAJO' },
    { id: generateUniqueId(), nombre: 'Jaiba', categoria: 'PROTEINA', cantidad: 10, caducidad: '2025-12-30', proveedor: 'Mariscos del Golfo', estado: 'ÓPTIMO' },
  ]);
