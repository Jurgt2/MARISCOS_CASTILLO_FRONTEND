...
const Mesero = () => {
  ...
  const { currentTable, currentOrder } = useOrderStore()
          ...
          <div className="container mx-auto px-4 py-6">
            ...
            {activeTab === 'menu' && (
              <div className="max-w-5xl mx-auto space-y-6">
                {/* Stats rápidos, mapa de mesas, menú, filtros, agrupación por categoría, notas y para llevar */}
                {/* ...existing code... */}
                {/* Resumen de orden siempre visible debajo del menú */}
                {currentTable && (
                  <div className="card-castillo">
                            ...
                            <div key={producto.id} className="card-castillo">
                              <div className="card-body flex flex-col justify-between">
                                ...
                                <div className="flex items-center justify-between mt-2">
                                  ...
                                  {/* Aquí va el botón de agregar, puedes personalizarlo si tienes lógica */}
