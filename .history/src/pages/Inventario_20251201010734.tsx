...
function Inventario() {
  ...
  const [ingredientes, setIngredientes] = useState([
    { id: 'ING01', nombre: 'Camarón Grande', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING02', nombre: 'Camarón Chico', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING03', nombre: 'Pulpo Español', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING04', nombre: 'Filete de Robalo', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING05', nombre: 'Mojarra entera', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING06', nombre: 'Huachinango', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING07', nombre: 'Jaiba viva', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING08', nombre: 'Ostiones en concha', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING09', nombre: 'Callo de hacha', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING10', nombre: 'Sierra', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING11', nombre: 'Arrachera marinada', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING12', nombre: 'Pechuga de pollo', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING13', nombre: 'Tocino', categoria: 'PROTEINA', unidad: 'kg' },
    { id: 'ING14', nombre: 'Tomate saladet', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING15', nombre: 'Cebolla blanca', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING16', nombre: 'Ajo', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING17', nombre: 'Chile serrano', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING18', nombre: 'Cilantro', categoria: 'VERDURA', unidad: 'manojos' },
    { id: 'ING19', nombre: 'Aguacate Hass', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING20', nombre: 'Limón', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING21', nombre: 'Pepino', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING22', nombre: 'Pimiento morrón rojo', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING23', nombre: 'Lechuga orejona', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING24', nombre: 'Jitomate', categoria: 'VERDURA', unidad: 'kg' },
    { id: 'ING25', nombre: 'Chile guajillo', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING26', nombre: 'Chile de árbol', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING27', nombre: 'Chipotle en adobo', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING28', nombre: 'Sal de grano', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING29', nombre: 'Pimienta negra molida', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING30', nombre: 'Orégano', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING31', nombre: 'Comino molido', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING32', nombre: 'Queso manchego rallado', categoria: 'LACTEO', unidad: 'kg' },
    { id: 'ING33', nombre: 'Crema ácida', categoria: 'LACTEO', unidad: 'L' },
    { id: 'ING34', nombre: 'Mantequilla sin sal', categoria: 'LACTEO', unidad: 'kg' },
    { id: 'ING35', nombre: 'Queso panela', categoria: 'LACTEO', unidad: 'kg' },
    { id: 'ING36', nombre: 'Arroz blanco', categoria: 'GRANOS', unidad: 'kg' },
    { id: 'ING37', nombre: 'Harina de trigo', categoria: 'GRANOS', unidad: 'kg' },
    { id: 'ING38', nombre: 'Pan molido', categoria: 'GRANOS', unidad: 'kg' },
    { id: 'ING39', nombre: 'Tortilla de maíz (saco 50 kg)', categoria: 'GRANOS', unidad: 'kg' },
    { id: 'ING40', nombre: 'Aceite vegetal', categoria: 'ACEITE', unidad: 'L' },
    { id: 'ING41', nombre: 'Aceite de oliva extra virgen', categoria: 'ACEITE', unidad: 'L' },
    { id: 'ING42', nombre: 'Coca-Cola 600 ml', categoria: 'BEBIDA', unidad: 'pzas' },
    { id: 'ING43', nombre: 'Cerveza Corona 355 ml', categoria: 'BEBIDA', unidad: 'pzas' },
    { id: 'ING44', nombre: 'Agua mineral 1 L', categoria: 'BEBIDA', unidad: 'pzas' },
    { id: 'ING45', nombre: 'Jugo de naranja natural', categoria: 'BEBIDA', unidad: 'L' },
    { id: 'ING46', nombre: 'Tequila (cocina)', categoria: 'BEBIDA', unidad: 'L' },
    { id: 'ING47', nombre: 'Clamato', categoria: 'BEBIDA', unidad: 'L' },
    { id: 'ING48', nombre: 'Salsa inglesa', categoria: 'CONDIMENTO', unidad: 'L' },
    { id: 'ING49', nombre: 'Salsa valentina', categoria: 'CONDIMENTO', unidad: 'L' },
    { id: 'ING50', nombre: 'Mayonesa', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING51', nombre: 'Catsup', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING52', nombre: 'Mostaza', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING53', nombre: 'Vinagre blanco', categoria: 'CONDIMENTO', unidad: 'L' },
    { id: 'ING54', nombre: 'Hojas de laurel', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING55', nombre: 'Consomé de camarón', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING56', nombre: 'Caldo de pollo en polvo', categoria: 'CONDIMENTO', unidad: 'kg' },
    { id: 'ING57', nombre: 'Papel aluminio', categoria: 'DESCARTABLE', unidad: 'rollos' },
    { id: 'ING58', nombre: 'Servilletas', categoria: 'DESCARTABLE', unidad: 'paquetes' },
    { id: 'ING59', nombre: 'Bolsas térmicas', categoria: 'DESCARTABLE', unidad: 'pzas' },
    { id: 'ING60', nombre: 'Guantes látex', categoria: 'LIMPIEZA', unidad: 'cajas' },
    { id: 'ING61', nombre: 'Jabón líquido', categoria: 'LIMPIEZA', unidad: 'L' },
    { id: 'ING62', nombre: 'Cloro', categoria: 'LIMPIEZA', unidad: 'L' },
    { id: 'ING63', nombre: 'Servitoallas', categoria: 'LIMPIEZA', unidad: 'rollos' },
    { id: 'ING64', nombre: 'Esponjas', categoria: 'LIMPIEZA', unidad: 'pzas' },
    { id: 'ING65', nombre: 'Limpiador multiusos', categoria: 'LIMPIEZA', unidad: 'L' },
    { id: 'ING66', nombre: 'Bolsas de basura 100 L', categoria: 'LIMPIEZA', unidad: 'pzas' },
    { id: 'ING67', nombre: 'Hielo en barra', categoria: 'CONGELADO', unidad: 'kg' },
    { id: 'ING68', nombre: 'Hielo picado', categoria: 'CONGELADO', unidad: 'kg' }
  ]);
