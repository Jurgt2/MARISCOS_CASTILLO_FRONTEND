...
const ingredientesMock: Ingrediente[] = [
  ...
  { id: '25', nombre: 'Pimienta Negra', categoria: 'CONDIMENTO', cantidad: 1, unidad: 'kg', cantidadMinima: 0.2, costoUnitario: 150, proveedor: 'Especias México',
...
export default function Inventario() {
  ...
  const handleRegisterMerma = () => {
    ...
    setIngredientes(ingredientes.map(i =>
      i.id === ingrediente.id
        ? { ...i, cantidad: i.cantidad - mermaForm.cantidad }
        : i
    ));
    ...
    // Alerta si afecta el stock mínimo
    if (ingrediente.cantidad - mermaForm.cantidad < ingrediente.cantidadMinima) {
      alert(`El stock de ${ingrediente.nombre} está por debajo del mínimo.`);
    }
  };
