            ...
            <div className="w-full lg:w-1/3 flex flex-col items-center">
              <div className="card-castillo w-full mb-6">
                <div className="card-body flex flex-col items-center">
                  ...
                  {currentTable && (
                    <div className="mt-4 px-4 py-2 rounded bg-success/10 text-success font-bold text-lg shadow text-center">
                      Mesa seleccionada: <span className="text-primary">{currentTable.number}</span>
                    </div>
                  )}
                </div>
              </div>
