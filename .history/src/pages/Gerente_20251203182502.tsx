                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-lg shadow p-4">
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Arrachera</td><td className="text-right font-semibold">$250.00</td></tr>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Cecina</td><td className="text-right font-semibold">$150.00</td></tr>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Milanesa de pollo</td><td className="text-right font-semibold">$135.00</td></tr>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Filete de pollo a la plancha</td><td className="text-right font-semibold">$135.00</td></tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-4">
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Papas a la francesa</td><td className="text-right font-semibold">$80.00</td></tr>
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Nuggets de pollo</td><td className="text-right font-semibold">$110.00</td></tr>
                        ...
                        <tr className="border-b hover:bg-gray-50"><td className="py-2">Camarones empanizados</td><td className="text-right font-semibold">$190.00</td></tr>
                      </tbody>
                    </table>
                  </div>
