        ...
        {activeTab === 'ordenes' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              ...
              <button
                className="btn btn-success mb-6 ml-2"
              ...
              {showSeleccionProductos && (
                <div className="card-castillo">
                  <div className="card-body">
                    ...
                    {/* Aquí puedes reutilizar ProductGridLite o un componente similar para agregar productos al carrito temporal */}
                    <ProductGridLite />
                  </div>
                </div>
              )}
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                <div className="card-castillo mb-6">
                  <div className="card-body">
                    <h2 className="card-title text-primary mb-4">
                      Selecciona una mesa
                    </h2>
                    {loadingTables ? (
                      ...
                      <TableMap tables={tables} onTableUpdate={() => {}} />
                    )}
                    {currentTable && (
                      <div className="mt-4 text-success font-bold text-lg">
                        Mesa seleccionada: {currentTable.number}
                      </div>
                    )}
                  </div>
                </div>
